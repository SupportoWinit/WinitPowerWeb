...
namespace Reports
{
    ...
    /// </summary>
    public partial class XRColTimesheet : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        /// <summary>
        /// Il controller per il calcolo dei totali da inserire nel report.
        /// </summary>
        private readonly TimesheetTotalController _tsTotalController;
        ...
        public XRColTimesheet(IEnumerable<TimesheetModuleItem> timesheets, TimesheetTotalController tsTotalController, List<string> sections = null, Dictionary<string, int> reportOptions = null)
            : this()
        {
            ...
            _tsTotalController = tsTotalController;
        ...
        private void ManageReportOptions(Dictionary<string, int> reportOptions)
        {
            // inizializzazione delle costanti con le chiavi di opzioni del report
            const string opzNoCantKey = "OPZ_NO_CANT";
            const string opzHideTotalDelta = "HideDeltaTotalTimehseetEnum";
            const string opzHideTotalPlan = "HidePlanTotalTimesheetEnum";
            const string opzHideTotalTotal = "HidelTotalTotalTimehsheetEnum";
            const string opzHideTotalAdditional = "HidelAdditionalTotalTimehsheetEnum";
            const string opzHideTotalJustification = "HideJustificationTotalTimehsheetEnum";
            const string opzHideTotalStrNoc = "HideStrNoctTotalTimehseetEnum";
            const string opzHideTotalArrot = "HideArrotTotalTimehseetEnum";
            const string opzHideTotalStr = "HideStrTotalTimehseetEnum";
            const string opzHideSection = "HideSectionTimehsheetEnum";
            const string opzShowZeroAsEmptyString = "TimesheetExportZeroValueFormatEnum";
            const string opzShowWeeklyTotals = "ShowWeeklyTotals";
            ...
            if (reportOptions != null)
            {
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzNoCantKey))
                    _showCant = !Convert.ToBoolean(reportOptions[opzNoCantKey]);

                // se è presente l'opzione di visualizzare le ore a zero come stringhe vuote, si imposta il campo relativo
                if (reportOptions.Any(kvp => kvp.Key == opzShowZeroAsEmptyString))
                    _showZeroAsEmptyString = Convert.ToBoolean(reportOptions[opzShowZeroAsEmptyString]);

                // se è richiesto il nascondimento del delta allora si procede al suo nascondimento
                if (reportOptions.Any(kvp => kvp.Key == opzHideTotalDelta))
                    if (Convert.ToBoolean(reportOptions[opzHideTotalDelta]))
                    {
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzHideTotalStr))
                    if (Convert.ToBoolean(reportOptions[opzHideTotalStr]))
                    {
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzHideTotalPlan))
                    if (Convert.ToBoolean(reportOptions[opzHideTotalPlan]))
                    {
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzHideTotalTotal))
                    if (Convert.ToBoolean(reportOptions[opzHideTotalTotal]))
                    {
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzHideTotalAdditional))
                    if (Convert.ToBoolean(reportOptions[opzHideTotalAdditional]))
                    {
                        rfStrMonth.Visible = false;
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzHideTotalJustification))
                    if (Convert.ToBoolean(reportOptions[opzHideTotalJustification]))
                    {
                        rfJustMonth.Visible = false;
                        chWeeklyTotalsJust.Visible = false;
                        cfWeek1JustTotal.Visible = false;
                ...
                // se è richiesto il nascondimento delle motivazioni dal totale allora si procede al loro nascondimento
                if (reportOptions.Any(kvp => kvp.Key == opzHideTotalStrNoc))
                    if (Convert.ToBoolean(reportOptions[opzHideTotalStrNoc]))
                    {
                        rfStrNocMonth.Visible = false;
                        chWeeklyTotalsStrNoc.Visible = false;
                        cfWeek1StrNocTotal.Visible = false;
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzHideTotalArrot))
                    if (Convert.ToBoolean(reportOptions[opzHideTotalArrot]))
                    {
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzShowWeeklyTotals))
                    if (!Convert.ToBoolean(reportOptions[opzShowWeeklyTotals]))
                    {
                ...
                if (reportOptions.Any(kvp => kvp.Key == opzHideSection))
                {
                    if (reportOptions[opzHideSection] == 1)
                    {
