...
{
    public class ClockAppManagerSynchronizer<T> : ISynchronizer<T> where T : class
    {
        ...
        public ClockAppManagerSynchronizer(IDictionary<string, string> connectionConfig, IDictionary<string, string> apiPaths)
        {
