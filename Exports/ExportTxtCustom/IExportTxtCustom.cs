...
{
    public interface IExportTxtCustom<T> where T : class
    {
        /// <summary>
        ...
        void LaunchExport(IEnumerable<int> selectedColIds, IEnumerable<int> selectedCantIds, bool isLaunchedWithErrors = false);

        /// <summary>
        /// Esegue la preparazione dell'export con i dati passati come parametro ritornando un eventuale errore.
        /// </summary>
        /// <param name="selectedColIds">L'elenco degli id collaboratore selezionati per l'export.</param>
        /// <param name="selectedCantIds">L'elenco degli id cantiere selezionati per l'export.</param>
        /// <returns>L'eventuale errore avvenuto durante l'esportazione</returns>
        string LaunchExportWithError(IEnumerable<int> selectedColIds, IEnumerable<int> selectedCantIds, bool isLaunchedWithoutErrors = false);

        string SaveToFileSystem(string path);

        string ExcelWorkbookSaveToSession(string fileName);
        /// <summary>
        /// Recupera o imposta il nome del file da esportare.
        /// </summary>
        /// <value>
        /// Il nome del file da esportare.
        /// </value>
        ...
        /// <summary>
        /// Recupera o imposta il valore che determina se comprimere o meno il file.
        /// </summary>
