    ...
    (function($, DX, undefined) {
        ...
        rangeSelector.RangeSelector = core.BaseWidget.inherit(function() {
            ...
            var calculateTranslatorRange = function(that, seriesDataSource, scaleOptions) {
                    ...
                    else if (_isDefined(scaleOptions.startValue) || _isDefined(scaleOptions.endValue)) {
            ...
            var getTicksInfo = function(that, scaleOptions, translators, screenDelta) {
                    ...
                    majorTicksOptions = {
                        ...
                        isStartTickGenerated: !_isDefined(that.option('scale').majorTickInterval),
                    ...
                    startValue = isEmpty ? businessRange.min : startValue;
                    endValue = isEmpty ? businessRange.max : endValue;
            ...
            var updateScaleOptions = function(that, seriesDataSource, translatorRange, screenDelta, scaleOptions) {
                    var minVisibleX = _isDefined(translatorRange.arg.minVisible) ? translatorRange.arg.minVisible : translatorRange.arg.min,
                        maxVisibleX = _isDefined(translatorRange.arg.maxVisible) ? translatorRange.arg.maxVisible : translatorRange.arg.max,
                        isEmptyInterval;
                    ...
                    scaleOptions.isEmpty = startEndNotDefined(scaleOptions.startValue, scaleOptions.endValue) || isEmptyInterval || scaleOptions.valueType === 'string';
            ...
            var prepareScaleOptions = function(that, seriesDataSource) {
                    ...
                    if (_isDefined(scaleOptions.startValue)) {
                    ...
                    if (_isDefined(scaleOptions.endValue)) {
