    ...
    function createStoreConfig(options) {
        ...
        function loadOptionsToActionParams(options, isCountQuery) {
            ...
            if (options) {
                ...
                if (options.sort)
                    result.sort = normalizeSorting(options.sort);
                ...
                if (options.totalSummary)
                    result.totalSummary = options.totalSummary;
            ...
            jQuery.extend(result, loadParams);
            ...
            load: function (loadOptions) {
                ...
                return send(
                    ...
                    function (d, res) {
                        ...
                        console.log(items);
                        if ("data" in items) {
                            d.resolve(items.data, { groupCount: items.groupCount, totalCount: items.totalCount });
                        }
                        else
                            d.resolve(items);
                    }
