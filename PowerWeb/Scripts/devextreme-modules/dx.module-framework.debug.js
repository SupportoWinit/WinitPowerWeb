    ...
    (function($, DX, undefined) {
        ...
        var prepareCommandToReplace = function(targetCommand, commandsToMerge) {
                ...
                $.each(commandsToMerge, function(_, commandToMerge) {
                    ...
                    if (behaviorEqual && commandToMerge.option("action") === null)
                        commandToMerge.option("action", targetCommand.option("action"));
                    if (needToReplace) {
                        targetCommand._element().remove();
                        return false
                    }
                });
        ...
        DX.framework.html.ViewEngine = Class.inherit({
            ...
            _loadTemplatesFromURL: function(url) {
                ...
                this._ajaxImpl({
                    ...
                    var error = new Error(DX.utils.stringFormat("Remote template cannot be loaded.\r\nUrl:{0}\r\nError:{1}.", url, errorThrown));
