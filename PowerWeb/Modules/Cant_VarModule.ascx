<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cant_VarModule.ascx.cs"
    Inherits="PowerWeb.Modules.Cant_VarModule" %>
...
<dx:ASPxGridView ID="gvCant_Var" runat="server" AutoGenerateColumns="False" Width="100%">
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="N_Cant_Var" VisibleIndex="1" Width="10%" ReadOnly="True" CellStyle-HorizontalAlign="Center">
        </dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataCheckColumn FieldName="Singola_Reg" Visible="False">
        </dx:GridViewDataCheckColumn>
        ...
        <dx:GridViewDataTextColumn FieldName="Tipologia_Can" VisibleIndex="10" Width="10%">
        </dx:GridViewDataTextColumn>
    ...
    <Templates>
        <DetailRow>
            <dx:ASPxGridView ID="gvCant_Var_Detail" runat="server" AutoGenerateColumns="False" Width="100%"
                OnInit="gvCant_Var_Detail_Init"
                OnBeforePerformDataSelect="gvCant_Var_Detail_BeforePerformDataSelect">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="Cant_Var_Id" Visible="false">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Cant_Id" Visible="False">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataSpinEditColumn FieldName="Arrot_Durata_Can" Visible="False">
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="Cap_Can" VisibleIndex="50" Width="5%" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="Cap_Nascita_Can" Visible="False">
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="Cli_Id" VisibleIndex="80" Width="10%">
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataTextColumn FieldName="Cod_Fisc_Can" Visible="False">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Codice_Cantiere" VisibleIndex="20" Width="10%">
                    ...
                    <dx:GridViewDataDateColumn FieldName="Data_Registrazione_Can" Visible="False">
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn FieldName="DataOraUltimaModifica_Can" VisibleIndex="1" Width="15%">
                        <PropertiesDateEdit EditFormat="DateTime" />
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn FieldName="DataVarGps_Can" Visible="False">
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn FieldName="Descrizione_Can" VisibleIndex="30" Width="15%">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn FieldName="DisAbilitazione_Can" VisibleIndex="110" Width="5%">
                    </dx:GridViewDataCheckColumn>
                    <dx:GridViewDataTimeEditColumn FieldName="Durata_Max_Gruppo_Notte_Ril_Can" Visible="False">
                    ...
                    <dx:GridViewDataTextColumn FieldName="Indirizzo_Can" Visible="false">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataSpinEditColumn FieldName="LatitudineGps_Can" Visible="False">
                    </dx:GridViewDataSpinEditColumn>
                    <dx:GridViewDataTimeEditColumn FieldName="Limite_Inizio_Notte_Can" Visible="False">
