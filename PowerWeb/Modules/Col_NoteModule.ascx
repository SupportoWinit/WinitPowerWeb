<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Col_NoteModule.ascx.cs"
    Inherits="PowerWeb.Modules.Col_NoteModule" %>
...
<dx:ASPxGridView ID="gvCol_Note" runat="server" AutoGenerateColumns="False" Width="100%" OnDetailRowExpandedChanged="gvCol_Note_DetailRowExpandedChanged">
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="N_Note_Col" VisibleIndex="1" Width="10%" ReadOnly="true" CellStyle-HorizontalAlign="Center">
        </dx:GridViewDataTextColumn>
    ...
    <Templates>
        <DetailRow>
            <dx:ASPxGridView ID="gvCol_Note_Detail" runat="server" AutoGenerateColumns="False" Width="100%"
                OnInit="gvCol_Note_Detail_Init"
                OnInitNewRow="gvCol_Note_Detail_InitNewRow"
                OnRowValidating="gvCol_Note_Detail_RowValidating"
                OnRowInserting="gvCol_Note_Detail_RowInserting"
                OnRowUpdating="gvCol_Note_Detail_RowUpdating"
                OnRowDeleting="gvCol_Note_Detail_RowDeleting"
                OnBeforePerformDataSelect="gvCol_Note_Detail_BeforePerformDataSelect">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="Col_Note_Id" Visible="false">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Col_Id" Visible="false">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn FieldName="Data_Nota_Col_Note" VisibleIndex="20" Width="10%">
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn FieldName="Data_Registrazione_Col_Note" Visible="False" ReadOnly="true">
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn FieldName="DataOraUltimaModifica_Col_Note" Visible="false" ReadOnly="true">
                        <PropertiesDateEdit EditFormat="DateTime" />
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataCheckColumn FieldName="DisAbilitazione_Col_Note" VisibleIndex="110" Width="5%">
                    </dx:GridViewDataCheckColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="Utenti_Id" VisibleIndex="30" Width="10%">
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataTextColumn FieldName="Nota_Col_Note" VisibleIndex="40" Width="60%">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="Tipo_Nota_Col_Note" VisibleIndex="10" Width="5%">
                    </dx:GridViewDataComboBoxColumn>
                </Columns>
            </dx:ASPxGridView>
        </DetailRow>
