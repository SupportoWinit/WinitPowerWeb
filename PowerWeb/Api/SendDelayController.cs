...
namespace PowerWeb.Api
{
    ...
    /// </summary>
    public class SendDelayController : GenericApi
    {
        ...
        protected override void ExecuteOperation()
        {
            ...
            #region INVIO DELLE TIMBRATURE
            Errors.Add(new KeyValuePair<string, string>("Delay", RepoManager.Reg_VRepo.InviaRitardi()));
            #endregion
        }
        #endregion
